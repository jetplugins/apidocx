package com.github.jetplugins.yapix.util;
...
public class PsiAnnotationSearchUtil {
     ...
     * @return
     */
    public static String getPsiParameterAnnotationParam(PsiModifierListOwner psiParameter, String annotationName,
            String paramName) {
     ...
     * @return
     */
    public static Boolean getPsiParameterAnnotationParamBoolean(PsiModifierListOwner psiParameter,
